...
const PrivacyPolicy = () => {
  return (
    <div className="privacyPolicy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Kuya Jher.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Kuya Jher, accessible from{" "}
            <a
              href="kuyajher.netlify.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              kuyajher.netlify.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By phone number: 09508358986</li>
      </ul>
    </div>
  );
};
